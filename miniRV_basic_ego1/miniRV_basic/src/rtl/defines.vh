...
`define ALU_SUB     5'h01  // a
`define ALU_AND     5'h02  // a
`define ALU_OR      5'h03
`define ALU_XOR     5'h04  // a
`define ALU_SLL     5'h05
`define ALU_SRL     5'h06  // a
`define ALU_SRA     5'h07  // a
`define ALU_EQ      5'h08
`define ALU_NE      5'h09
`define ALU_SLT     5'h0A  // a
`define ALU_SLTU    5'h0B  // a
`define ALU_LT      5'h0C  // a
`define ALU_LTU     5'h0D  // a
`define ALU_GE      5'h0E  // a
`define ALU_GEU     5'h0F  // a 
`define ALU_MUL     5'h10  // a
`define ALU_MULH    5'h11  // a
`define ALU_MULHU   5'h12  // a
`define ALU_DIV     5'h13  // a
`define ALU_DIVU    5'h14  // a
`define ALU_REM     5'h15  // a
`define ALU_REMU    5'h16  // a   
    
`define NPC_PC4     2'b00
`define NPC_JALR    2'b01  // a
`define NPC_BRA     2'b10
`define NPC_JMP     2'b11
    
`define EXT_I       3'b000
`define EXT_S       3'b001 // a
`define EXT_B       3'b010
`define EXT_U       3'b011
`define EXT_J       3'b100
